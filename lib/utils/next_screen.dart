...
import 'package:news_app/pages/audio_article_details.dart';
...
void navigateToDetailsScreen(context, Article article, String? heroTag) {
  if (article.contentType == 'video') {
    debugPrint("video id${article.videoID}");
    // getStreamLink(article.videoID!);
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              VideoArticleDetails( data: article)),
    );
  } else if (article.contentType == 'image') {
    Navigator.push(
      context,
      MaterialPageRoute(
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
          builder: (context) =>
              AudioArticleDetails(data: article, tag: heroTag)),
    );
  }
}
