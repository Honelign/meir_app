  ...
  handleGoogleSignIn() async{
    ...
    await AppService().checkInternet().then((hasInternet)async{
      if(hasInternet == false){
        openSnacbar(scaffoldKey, context, 'check your internet connection!'.tr());
      }
      else{
        await sb.signInWithGoogle().then((_){
        if(sb.hasError == true){
          openSnacbar(scaffoldKey, context, 'something is wrong. please try again.'.tr());
  ...
  void handleFacebbokLogin () async{
    ...
    await AppService().checkInternet().then((hasInternet)async{
      if(hasInternet == false){
        ...
        if(sb.hasError == true){
          openSnacbar(scaffoldKey, context, 'error fb login'.tr());
