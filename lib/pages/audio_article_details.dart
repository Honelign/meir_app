...
class AudioArticleDetails extends StatefulWidget {
  final Article? data;
  final String? tag;

  const AudioArticleDetails({Key? key, required this.data, required this.tag})
      : super(key: key);

  @override
  _AudioArticleDetailsState createState() => _AudioArticleDetailsState();
}

class _AudioArticleDetailsState extends State<AudioArticleDetails> {
                                      ...
                                      children: [
                                        Center(
                                          child: AudioPlayerWidget(
                                            url: widget.data!.youtubeVideoUrl.toString(),
