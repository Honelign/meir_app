...
class _SearchPageState extends State<SearchPage> {
  ...
  void initState() {
    ...
    .then((value) => context.read<SearchBloc>().saerchInitialize(widget.category));
    super.initState();
  }
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          suffixIcon: IconButton(
            ...
            onPressed: () {
              context.read<SearchBloc>().saerchInitialize(widget.category);
            },
          ),
        ),
        ...
        onEditingComplete: () async {
          ...
          context.read<SearchBloc>().onFieldSubmitted();
        },
/*
        onSubmitted: (value) {
          if (value.isEmpty) {
            ...
            context.read<SearchBloc>().onFieldSubmitted(value);
          }
        },
*/
      ),
